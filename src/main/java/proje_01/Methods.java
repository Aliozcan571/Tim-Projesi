...
public class Methods extends ProductList {
    ...
    public static void addProduct() throws InterruptedException {
        ...
        Thread.sleep(2000); // ufak bir beklemeden sonra ana menü tekrar geri gelir.
    ...
    public static void manageStockAmountAndShelf() {
        ...
        do {
            try {
                    ...
                    if (productListMap.containsKey(findId)) {
                        ...
                        do {
                            try {
                                ...
                                System.err.println("Hatalı giriş yaptınız, lütfen geçerli miktar giriniz.");
                                scan.nextLine(); // dummy
                            }
                        ...
                        if (defaultStock < 0) {
                            System.err.println("Miktar negatif değer olamaz.");
                        } else {
                            productListMap.get(findId).setStockAmount(defaultStock + productListMap.get(findId).getStockAmount());
                            System.out.println("Ürün miktarı güncellendi. \nGüncel stok: " + productListMap.get(findId).getStockAmount());
                        }

                    } else {
                        System.err.println("Aradığınız ürün sistemde bulunmamaktadır.");
                    }
                ...
                System.err.println("Hatalı giriş yaptınız, lütfen geçerli bir ürün Id'si giriniz. Çıkış için 0'a basınız.");
                scan.nextLine(); // dummy
    ...
    public static void putToShelf() {
        ...
        do {
            try {
                            ...
                            try {
                                ...
                                switch (shelf) {
                                    ...
                                    case 5:
                                        ...
                                        break;
                                    default:
                                        System.err.println("Geçerli bir raf numarası giriniz.");

                                }
                            } catch (InputMismatchException e) {
                                System.err.println("Hatalı giriş yaptınız, lütfen geçerli seçim giriniz.");
                ...
                System.err.println("Hatalı giriş yaptınız, lütfen geçerli bir ürün Id'si giriniz.");
                scan.nextLine(); // dummy
            } catch (InterruptedException e) {
                throw new RuntimeException(e);
            }
    ...
    public static void removeStockAndId() {
        ...
        try {
            ...
            System.err.println("Hatalı giriş yaptınız. Lütfen geçerli bir seçim yapınız.");
            scan.nextLine(); // dummy
            removeStockAndId();
        ...
        try {
            ...
            if (removeId != 0) {   //0'la çıkabilmek için
                if (productListMap.containsKey(removeId)) {
                    ...
                    System.err.println(removeId + " numaralı ID sistemde bulunmamaktadır ");
            ...
            System.err.println("Hatalı giriş yaptınız. Lütfen geçerli bir Id giriniz.");
            scan.nextLine(); // dummy
            removeId();
        ...
        try {
            ...
            if (findId != 0) {
                ...
                if (productListMap.containsKey(findId)) {
                    ...
                    try {
                        if (removeAmount < 0) {
                            System.err.println("Stok miktari negatif değer içeremez. ");
                            removeStock();
                        }
                    ...
                    if (removeAmount <= productListMap.get(findId).getStockAmount()) {
                        ...
                        System.err.println("Stokta girilen miktardan az ürün bulunmaktadır.");
                        removeStock();
                    }
                } else {
                    System.err.println("Aradığınız ürün sistemde bulunmamaktadır.");
